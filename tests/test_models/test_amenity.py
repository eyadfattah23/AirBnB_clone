...
class TestState(unittest.TestCase):
    ...
    def test_str(self):
        ...
        self.assertEqual(str(self.my_model), "[Amenity] ({}) {}".format(
    ...
    def test_args(self):
        ...
        self.assertIsInstance(self.args_base, Amenity)
    ...
    def test_args_and_kwargs(self):
        """test initialization of a base model instance with args
                and no kwargs"""
        base3 = Amenity(1, 2, name='best_school', num=89)
        base4 = Amenity(name='bestest_school', num=8989)
        self.assertIsInstance(base3, Amenity)
        ...
        self.assertIsInstance(base4, Amenity)
